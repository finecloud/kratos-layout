...
type PayCreateReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *PayCreateReply) Reset() {
	*x = PayCreateReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *PayCreateReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayCreateReply) ProtoMessage() {}

func (x *PayCreateReply) ProtoReflect() protoreflect.Message {
	mi := &file_api_pay_v1_pay_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayCreateReply.ProtoReflect.Descriptor instead.
func (*PayCreateReply) Descriptor() ([]byte, []int) {
...
var file_api_pay_v1_pay_proto_rawDesc = []byte{
	...
	,
...
var file_api_pay_v1_pay_proto_goTypes = []interface{}{
	(*PayCreateRequest)(nil), // 0: pay.v1.PayCreateRequest
	(*PayCreateReply)(nil),   // 1: pay.v1.PayCreateReply
}
var file_api_pay_v1_pay_proto_depIdxs = []int32{
	0, // 0: pay.v1.Pay.createPay:input_type -> pay.v1.PayCreateRequest
	1, // 1: pay.v1.Pay.createPay:output_type -> pay.v1.PayCreateReply
