...
func (c *orderClient) CreateOrder(ctx context.Context, in *OrderCreateRequest, opts ...grpc.CallOption) (*OrderCreateReply, error) {
...
func (UnimplementedOrderServer) CreateOrder(context.Context, *OrderCreateRequest) (*OrderCreateReply, error) {
